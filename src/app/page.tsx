        ...
        <div className="bg-stone-100 border-b border-stone-200 px-5 py-3 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              <a href="viber://chat?number=+380987194210" className="text-[#7360f2] hover:scale-110 transition shadow-sm rounded-lg" title="Viber"><FaViber className="w-7 h-7" /></a>
              <a href="https://t.me/+380987194210" className="text-[#2AABEE] hover:scale-110 transition shadow-sm rounded-full" title="Telegram"><FaTelegram className="w-7 h-7" /></a>
              <a href="https://wa.me/380987194210" className="text-[#25D366] hover:scale-110 transition shadow-sm rounded-full" title="WhatsApp"><FaWhatsapp className="w-7 h-7" /></a>
            </div>
          </div>
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              <a href="viber://chat?number=+380987194245" className="text-[#7360f2] hover:scale-110 transition shadow-sm rounded-lg" title="Viber"><FaViber className="w-7 h-7" /></a>
              <a href="https://t.me/+380987194245" className="text-[#2AABEE] hover:scale-110 transition shadow-sm rounded-full" title="Telegram"><FaTelegram className="w-7 h-7" /></a>
              <a href="https://wa.me/380987194245" className="text-[#25D366] hover:scale-110 transition shadow-sm rounded-full" title="WhatsApp"><FaWhatsapp className="w-7 h-7" /></a>
            </div>
          </div>
        </div>
        ...
        <footer className="text-center py-8 text-stone-400 text-sm bg-stone-900 border-t border-stone-800">
          <div className="flex flex-col gap-4 px-5 mb-6 text-stone-300">
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-3">
                <a href="viber://chat?number=+380987194210" className="text-[#7360f2] hover:scale-110 transition" title="Viber"><FaViber className="w-8 h-8" /></a>
                <a href="https://t.me/+380987194210" className="text-[#2AABEE] hover:scale-110 transition" title="Telegram"><FaTelegram className="w-8 h-8" /></a>
                <a href="https://wa.me/380987194210" className="text-[#25D366] hover:scale-110 transition" title="WhatsApp"><FaWhatsapp className="w-8 h-8" /></a>
              </div>
            </div>
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-3">
                <a href="viber://chat?number=+380987194245" className="text-[#7360f2] hover:scale-110 transition" title="Viber"><FaViber className="w-8 h-8" /></a>
                <a href="https://t.me/+380987194245" className="text-[#2AABEE] hover:scale-110 transition" title="Telegram"><FaTelegram className="w-8 h-8" /></a>
                <a href="https://wa.me/380987194245" className="text-[#25D366] hover:scale-110 transition" title="WhatsApp"><FaWhatsapp className="w-8 h-8" /></a>
              </div>
            </div>
          </div>
